...
<body>
	<?php require_once("navigation.php"); ?>
    	...
    	<div class="innerBox">
        	<div class="contentTitle">Events in Raleigh - Thursday</div><br />
            <?php
          ...
          but we also have a list of upcoming special events as well, so please feel free to look at those as well! These are the events in Raleigh for Thursday, 
