...
<title>Events in Raleigh - Thursday</title>
...
<body>
    	...
    	<div class="innerBox">
        	<div class="contentTitle">Thursday Raleigh Events</div><br />
            <?php
            $conn =  Common::getConn();
			$query = "SELECT f.firm_id, f.name, f.website, f.address, f.city, f.state, f.zip, ds.long_description, ds.short_description FROM firm f, thursday_events ds ";
          ...
          have a list of upcoming special events though, so please feel free to look at those as well! These are the events in Raleigh for Thursday, but we also have 
