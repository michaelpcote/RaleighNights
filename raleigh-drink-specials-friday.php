...
<body>
	<?php require_once("navigation.php"); ?>
    	...
    	<div class="innerBox">
          ...
          <p>Raleigh Nights is pleased to present you with a list of Raleigh drink specials! This is the Friday list, so if you want to see another day please select
