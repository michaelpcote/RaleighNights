...
<body>
	<?php require_once("navigation.php"); ?>
    	...
    	<div class="innerBox">
        	<div class="contentTitle">Monday Raleigh Food Specials</div><br />
            <?php
            $conn =  mysqli_connect('ec2-54-213-248-248.us-west-2.compute.amazonaws.com', 'root', '>Password1', 'Raleigh_Nights' );
			$query = "SELECT f.firm_id, f.name, f.website, f.address, f.city, f.state, f.zip, ds.long_description, ds.short_description FROM firm f, monday_food_specials ds ";
