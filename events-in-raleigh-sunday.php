...
<title>Events in Raleigh - Sunday</title>
...
<body>
    	...
    	<div class="innerBox">
        	<div class="contentTitle">Sunday Raleigh Events</div><br />
            <?php
            $conn =  Common::getConn();
			$query = "SELECT f.firm_id, f.name, f.website, f.address, f.city, f.state, f.zip, ds.long_description, ds.short_description FROM firm f, sunday_events ds ";
          ...
          have a list of upcoming special events though, so please feel free to look at those as well! These are the events in Raleigh for Sunday, but we also have 
