...
<title>Edit Raleigh Drink Specials</title>
...
<body>
    	...
    	<div class="innerBox">
        	<div class="contentTitle">Edit Raleigh Drink Specials</div><br />
            <?php
			...
			$query .= "LEFT OUTER JOIN monday_drink_specials mon ON f.firm_id = mon.firm_id ";
			$query .= "LEFT OUTER JOIN tuesday_drink_specials tues ON f.firm_id = tues.firm_id ";
			$query .= "LEFT OUTER JOIN wednesday_drink_specials wed ON f.firm_id = wed.firm_id ";
			$query .= "LEFT OUTER JOIN thursday_drink_specials thurs ON f.firm_id = thurs.firm_id ";
			$query .= "LEFT OUTER JOIN friday_drink_specials fri ON f.firm_id = fri.firm_id ";
			$query .= "LEFT OUTER JOIN saturday_drink_specials sat ON f.firm_id = sat.firm_id ";
			$query .= "LEFT OUTER JOIN sunday_drink_specials sun ON f.firm_id = sun.firm_id ";
			$query .= "WHERE f.firm_id = ".$_SESSION['firm_id'];
			$result = $conn->query($query);
			?>
          <div class="contentText">
          <p>This page will enable you to edit the drink specials. If this is not the restuarnt or bar that you would like to edit drink specials for, please
        ...
        <form action="direct/admin-edit-specials-process.php" method="post" id="delete">
        	<fieldset>
                <legend>Edit Drink Specials for <?php echo $name ?></legend>
                <div class="field">
                ...
                <input type="hidden" name="type" value="drink_specials" />
			</fieldset>
			<div class="buttons">
