...
<title>Raleigh Drink Specials - Saturday</title>
...
<body>
    	...
    	<div class="innerBox">
        	<div class="contentTitle">Saturday Raleigh Drink Specials</div><br />
            <?php
            $conn =  Common::getConn();
			$query = "SELECT f.firm_id, f.name, f.website, f.address, f.city, f.state, f.zip, ds.long_description, ds.short_description FROM firm f, saturday_drink_specials ds ";
			$query .= "WHERE f.verified = 1 AND f.firm_id = ds.firm_id ORDER BY f.name";
			$result = $conn->query($query);
			?>
          <div class="contentText">
          <p>Raleigh Nights is pleased to present you with a list of Raleigh drink specials! These are the Saturday drink specials, so if you want to see another 
          day please select
