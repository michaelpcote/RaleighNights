...
<body>
	<?php require_once("navigation.php"); ?>
    	...
    	<div class="innerBox">
          ...
          have a list of upcoming special events as well though, so please feel free to look at those as well! These are the events in Raleigh for today, but we also have 
          the events for every other day of the week. If you want to see a particular day please select
