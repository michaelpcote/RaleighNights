...
<body>
	<?php require_once("navigation.php"); ?>
    	...
    	<div class="innerBox">
        	<div class="contentTitle">Tuesday Raleigh Food Specials</div><br />
            <?php
            $conn =  mysqli_connect('ec2-54-213-248-248.us-west-2.compute.amazonaws.com', 'root', '>Password1', 'Raleigh_Nights' );
			$query = "SELECT f.firm_id, f.name, f.website, f.address, f.city, f.state, f.zip, ds.long_description, ds.short_description FROM firm f, tuesday_food_specials ds ";
			$query .= "WHERE f.verified = 1 AND f.firm_id = ds.firm_id ORDER BY f.name";
			$result = $conn->query($query);
			?>
          <div class="contentText">
          <p>Raleigh Nights is pleased to present you with a list of Raleigh food specials! These are the food specials on Tuesday, so if you want to see another day please
