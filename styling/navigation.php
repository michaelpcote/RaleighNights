            ...
            <ul>
                ...
                <li><a href="admin-edit-special-events.php">Special Events</a>
                	<ul>
                        ...
                        <li><a href="admin-add-new-special-event.php">And New Special Event</a></li>
                    </ul>
                </li>
	...
	<?php } else if ( isset($_SESSION['user_type'] ) ) { ?>
     	<div id="navcontainer">
            <ul>
                ...
                <li><a href="user-restaurant-and-bar-lists.php">Your Places</a></li>
                <li><a href="user-edit-drink-specials.php">Drink Specials</a></li>
                <li><a href="user-edit-food-specials.php">Food Specials</a></li>
                <li><a href="user-edit-events.php">Reocurring Events</a></li>
                <li><a href="user-edit-special-events.php">Special Events</a>
                	<ul>
                        <li><a href="user-previous-special-events-list.php">Edit Previous Special Event</a></li>
                        <li><a href="user-upcoming-special-events-list.php">Edit Upcoming Special Event</a></li>
                        <li><a href="user-add-new-special-event.php">And New Special Event</a></li>
                    </ul>
                </li>
            </ul>
        </div>
...
<div id="mainPicture">
    <div class="picture">
        ...
        <div id="headerSubtext">Discover Raleigh's Nightlife</div>
    </div>
</div>