...
<title>Events in Raleigh - Monday</title>
...
<body>
    	...
    	<div class="innerBox">
        	<div class="contentTitle">Monday Raleigh Events</div><br />
            <?php
            $conn =  Common::getConn();
			$query = "SELECT f.firm_id, f.name, f.website, f.address, f.city, f.state, f.zip, ds.long_description, ds.short_description FROM firm f, monday_events ds ";
          ...
          have a list of upcoming special events though, so please feel free to look at those as well! These are the events in Raleigh for Monday, but we also have 
